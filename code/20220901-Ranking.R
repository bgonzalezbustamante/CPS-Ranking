...
Affiliation <- c("UMAYOR", ## 1. Alejandro Olivares L.
                 ...
                 "UDP-Leiden", ## 100. Sebastián Umpierrez
                 ...
                 "LSE", ## 162. Diego Sazo
                 "UCHILE", ## 163. Felipe Agüero
                 "PUC", ## 164. Hernán Campos-Parra
                 "UDP",  ## 165. Nicolás Mimica
...
## Export CSV
write.csv(data,'20220901/20220901_ranking.csv', fileEncoding = "UTF-8")
save.image("20220901/Ranking-Sep-2022.RData")

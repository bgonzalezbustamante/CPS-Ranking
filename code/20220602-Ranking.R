...
LWLkiYMAAAAJ <- get_profile('LWLkiYMAAAAJ') ## Amy L. Atchison
...
muKzXeYAAAAJ <- get_profile('muKzXeYAAAAJ') ## Diego Sazo
...
ID <- c(POHGEtYAAAAJ$id, ## Alejandro Olivares L.
        ...
        LWLkiYMAAAAJ$id, ## Amy L. Atchison
...
Aff <- c(POHGEtYAAAAJ$affiliation, ## Alejandro Olivares L.
        ...
        LWLkiYMAAAAJ$affiliation, ## Amy L. Atchison
...
Affiliation <- c("UMAYOR", ## 1. Alejandro Olivares L.
                 ...
                 "PUC", ## 13. Catherine Reyes-Housholder
                 "UCHILE", ## 14. Cecilia Osorio Gonnet
                 "USACH", ## 15. Cesar Ross
                 "UCT", ## 16. Christopher Martínez
                 "UCHILE", ## 17. Claudia Heiss
                 "UDP", ## 18. Claudio Fuentes
                 "UACH", ## 19. Claudio Fuentes-González
                 "USACH", ## 20. Cristian Garay Vera
                 "UF", ## 21. Cristian Pérez
                 "PUC", ## 22. Cristian Pliscoff
                 "USACH", ## 23. Cristina Moyano Barahona
                 "UAI", ## 24. Cristóbal Bellolio
                 "UDP", ## 25. Cristóbal Rovira
                 "UDP", ## 26. Cristóbal Sandoval
                 "LSE", ## 27. Daniel Brieba
                 "ULAGOS", ## 28. Daniel Flores Cáceres
                 "USACH", ## 29. Daniel Santibañez
                 "PUC-VDEM", ## 30. David Altman
                 "UAI", ## 31. Diego Rossello
                 "UACH", ## 32. Egon Montecinos
                 "NWU", ## 33. Ely Orrego
                 "UDEC", ## 34. Esteban Valenzuela
                 "UDD", ## 35. Eugenio Guzmán
                 "UDP", ## 36. Evelyn Arriagada
                 "UDD", ## 37. Felipe Schwember
                 "UCHILE", ## 38. Fernando Atria
                 "UDP", ## 39. Fernando Rosenblatt
                 "UDD", ## 40. Fernando Schmidt
                 "UDP", ## 41. Francisca Lisbona
                 "PUC", ## 42. Francisco Urdinez
                 "UDP", ## 43. Germán Campos-Herrera
                 "UDP", ## 44. Gonzalo Espinoza Bianchini
                 "UA", ## 45. Hugo Jofré
                 "UDEC", ## 46. Ines Picazo Verdejo
                 "UAH", ## 47. Isaac Caro
                 "UDEC", ## 48. Jaime Contreras Alvarez
                 "UDP", ## 49. Javier Couso
                 "UDEC", ## 50. Jeanne W. Simon
                 "UDD", ## 51. Jorge Fabrega
                 "UDD", ## 52. Jose de la Cruz Garrido
                 "UACH", ## 53. José Hernández-Bonivento
                 "UCT", ## 54. Juan Carlos Arellano
                 "UOH", ## 55. Juan Pablo Araya
                 "UDD", ## 56. Juan Pablo Couyoumdjian
                 "PUC", ## 57. Juan Pablo Luna
                 "PUC", ## 58. Julieta Suarez-Cao
                 "USS", ## 59. Karen Manzano
                 "UDEC", ## 60. Katherine Figueroa Aillañir
                 "UDP", ## 61. Kenneth Bunker
                 "LSE-COES", ## 62. Kirsten Sehnbruch
                 "STU", ## 63. Laura Levick
                 "UDP", ## 64. Lisa Zanotti
                 "UCHILE", ## 65. Lorena Oyarzún Serrano
                 "ANEPE", ## 66. Loreto Correa
                 "USACH", ## 67. Lucia Dammert
                 "USACH", ## 68. Luis Clavería Cambón
                 "PUC", ## 69. Marcelo Marzouka
                 "ULAGOS", ## 70. María Gabriela Cordova
                 "UDEC", ## 71. Mariol Virgili Lillo
                 "PUC", ## 72. Matias Bargsted
                 "UDD", ## 73. Matthias Erlandsen
                 "UDD", ## 74. Mauricio Apablaza
                 "UTALCA", ## 75. Mauricio Morales Quiroga
                 "USACH", ## 76. Mauricio Olavarría-Gambi
                 "UTEM", ## 77. Máximo Quitral
                 "UCHILE", ## 78. Mireya Dávila
                 "IIPSS", ## 79. Nicolás Del Valle
                 "PUC", ## 80. Nicolás M. Somma
                 "UAI", ## 81. Nicole Darat
                 "PUC", ## 82. Nicole Jenne
                 "UCHILE", ## 83. Octavio Avendaño
                 "UCHILE", ## 84. Olga Espinoza
                 "PUC", ## 85. Pablo Valenzuela
                 "UDP-NYU", ## 86. Patricio Navia
                 "UACH", ## 87. Patricio Valdivieso
                 "COES", ## 88. Peter Siavelis
                 "UVALPO", ## 89. Pierre Ostiguy
                 "USACH", ## 90. Rene Jara
                 "UCHILE", ## 91. Ricardo Gamboa
                 "UCHILE", ## 92. Robert L. Funk
                 "UBB", ## 93. Roberto Mardones
                 "UCT", ## 94. Rodolfo Disi Pavlic
                 "UCHILE", ## 95. Rodrigo Cuevas
                 "UAH", ## 96. Rodrigo Medel
                 "UDP", ## 97. Rodrigo Osorio
                 "UDP", ## 98. Rossana Castiglioni
                 "UCHILE", ## 99. Sandra Baquedano
                 "UCT", ## 100. Sebastián Carrasco
                 "UDP-Leiden", ## 101. Sebastián Umpierrez
                 "UDEC", ## 102. Sergio Toro Maureira
                 "UAH", ## 103. Shirley Gotz
                 "UCHILE", ## 104. Sofia Donoso
                 "UNAB", ## 105. Stéphanie Alenda
                 "PUC", ## 106. Susana Gazmuri
                 "PUCP", ## 107. Tomas Dosek
                 "PUC", ## 108. Umut Aydin
                 "PUC", ## 109. Valeria Palanza
                 "UCHILE", ## 110. Veronica Figueroa Huencho
                 "UDD", ## 111. Vesna Mandakovic
                 "UDEC", ## 112. Violeta Montero
                 "UDEC", ## 113. Waleska Muñoz Aravena
                 "PUC", ## 114. William Porath
                 "PURDUE", ## 115. Giancarlo Visconti
                 "PUC", ## 116. Gabriel L. Negretto
                 "CMU", ## 117. Ignacio Arana Araya
                 "UMAYOR", ## 118. José Miguel Cabezas
                 "PUC", ## 119. Rodrigo Mardones
                 "UDP", ## 120. Macarena Valenzuela
                 "UDELAR", ## 121. Germán Bidegain
                 "unk.", ## 122. Victor Tricot Salomon
                 "UnB", ## 123. Adrian Albala
                 "UCHILE", ## 124. Miguel Angel Lopez
                 "USACH", ## 125. Marcelo Mella Polanco
                 "UCHILE", ## 126. Hary Hugo Fruhling
                 "UAI", ## 127. Arturo Arriagada
                 "unk.", ## 128. Jorge Gordin
                 "PUC", ## 129. Stefano Palestini
                 "PUC", ## 130. Ross Mittiga
                 "PUC", ## 131. Alfonso Donoso
                 "PUC", ## 132. Giovanni Agostinis
                 "IL", ## 133. Antonio Canale-Mayet
                 "QMUL", ## 134. Javier Sajuria
                 "UCHILE", ## 135. Federico Rojas-de-Galarreta
                 "KCL", ## 136. Ximena Soto Soutullo
                 ...
                 "unk.", ## 144. Carlos Cantillana
                 "UCT", ## 145. Rodolfo de Camargo Lima
                 "PUC", ## 146. María Patricia Sotomayor Valarezo
                 "PUC", ## 147. Sergio A. Huertas-Hernandez
                 "UDP", ## 148. Aldo Madariaga
                 "Leiden", ## 149. Carla Cisternas 
                 "UDEC", ## 150. Armando Cartes Montory
                 "UCHILE", ## 151. María Cristina Escudero
                 "UCL", ## 152. Javiera Arce
                 "PUC", ## 153. Carla Alberti
                 "WARW", ## 154. Cristóbal Bywaters C.
                 "UDP", ## 155. Maite De Cea
                 "FLACSO",  ## 156. Lucia Miranda Leibe
                 "UDP", ## 157. Carlos Meléndez
                 "PUC", ## 158. Nerea C. Palma
                 "PUC", ## 159. Diego Telias
                 "UVALPO", ## 160. Amy L. Atchison
                 "UDP", ## 161. Arlette Martínez Ossa
                 "CU", ## 162. Pablo Argote
                 "UCHILE", ## 163. Jaime Baeza Freer
                 "UNAP", ## 164. Gonzalo Alvarez Fuentes
                 "LSE", ## 165. Diego Sazo
                 "UCHILE", ## 166. Felipe Agüero
                 "PUC", ## 167. Hernán Campos-Parra
                 "UDP",  ## 168. Nicolás Mimica
                 "UOB", ## 169. Leslie Wehner
                 "UDP", ## 170. Ariel Becerra
                 "USACH", ## 171. Constanza Jorquera Mery
                 "UCHILE", ## 172. Karina Arias Yurisch
                 "UCHILE", ## 173. Álvaro Ramírez-Alujas
                 "UVALPO" ## 174. Diego Barría Traverso
                 )
...
Cites <- c(POHGEtYAAAAJ$total_cites, ## Alejandro Olivares L.
           ...
           LWLkiYMAAAAJ$total_cites, ## Amy L. Atchison
...
H_Index <- c(POHGEtYAAAAJ$h_index, ## Alejandro Olivares L.
             ...
             LWLkiYMAAAAJ$h_index, ## Amy L. Atchison
...
## Export CSV
write.csv(data,'20220602/20220602_ranking.csv', fileEncoding = "UTF-8")
save.image("20220602/Ranking-Jun-2022.RData")

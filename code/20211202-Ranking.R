...
Affiliation <- c("UCT", ## 1. Alejandro Olivares L.
                 ...
                 "MMC", ## 144. Lucas Perelló
                 "unk.", ## 145. Carlos Cantillana
                 "UCT", ## 146. Rodolfo de Camargo Lima
                 "PUC", ## 147. María Patricia Sotomayor Valarezo
                 "PUC", ## 148. Sergio A. Huertas-Hernandez
                 "UDP", ## 149. Aldo Madariaga
                 "Leiden", ## 150. Carla Cisternas 
                 "UDEC", ## 151. Armando Cartes Montory
                 "UCHILE", ## 152. María Cristina Escudero
                 "UCL", ## 153. Javiera Arce
                 "PUC", ## 154. Carla Alberti
                 "WARW", ## 155. Cristóbal Bywaters C.
                 "UDP", ## 156. Maite De Cea
                 "FLACSO",  ## 157. Lucia Miranda Leibe
                 "UDP", ## 158. Carlos Meléndez
                 "PUC", ## 159. Nerea C. Palma
                 "PUC", ## 160. Diego Telias
                 "UVALPO", ## 161. Amy L. Atchison
                 "UDP", ## 162. Arlette Martínez Ossa
                 "CU", ## 163. Pablo Argote
...
## Export CSV
write.csv(data,'20211202/20211202_ranking.csv', fileEncoding = "UTF-8")
save.image("20211202/Ranking-Dec-2021.RData")

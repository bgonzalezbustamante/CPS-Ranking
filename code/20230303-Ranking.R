...
Affiliation <- c("UMAYOR", ## 1. Alejandro Olivares L.
                 ...
                 "unk.", ## 126. Jorge Gordin
                 "PUC", ## 127. Stefano Palestini
                 "PUC", ## 128. Ross Mittiga
                 "PUC", ## 129. Alfonso Donoso
                 "UNIBO", ## 130. Giovanni Agostinis
                 "IL", ## 131. Antonio Canale-Mayet
                 "QMUL", ## 132. Javier Sajuria
                 "UCHILE", ## 133. Federico Rojas-de-Galarreta
                 "KCL", ## 134. Ximena Soto Soutullo
                 "UCHILE", ## 135. Luis Garrido-Vergara
                 "UCT", ## 136. Carolina Acevedo
                 "UCHILE", ## 137. Andrés Dockendorff
                 "UTU", ## 138. Hector Bahamonde
                 "unk.", ## 139. Renata Retamal Iturriaga
                 "OXF", ## 140. Gonzalo Contreras Aguirre
                 "SC", ## 141. Lucas Perelló
                 "unk.", ## 142. Carlos Cantillana
                 "UCT", ## 143. Rodolfo de Camargo Lima
                 "PUC", ## 144. María Patricia Sotomayor Valarezo
                 "PUC", ## 145. Sergio A. Huertas-Hernandez
                 "UDP", ## 146. Aldo Madariaga
                 "Leiden", ## 147. Carla Cisternas 
                 "UDEC", ## 148. Armando Cartes Montory
                 "UCHILE", ## 149. María Cristina Escudero
                 "UCL", ## 150. Javiera Arce
                 "PUC", ## 151. Carla Alberti
                 "WARW", ## 152. Cristóbal Bywaters C.
                 "UDP", ## 153. Maite De Cea
                 "FLACSO",  ## 154. Lucia Miranda Leibe
                 ...
                 "UNAP", ## 161. Gonzalo Alvarez Fuentes
                 ## "LSE", ## Diego Sazo (deleted account)
                 "UCHILE", ## 162. Felipe Agüero
                 "PUC", ## 163. Hernán Campos-Parra
                 "UDP",  ## 164. Nicolás Mimica
                 "UOB", ## 165. Leslie Wehner
                 "UDP", ## 166. Ariel Becerra
                 "USACH", ## 167. Constanza Jorquera Mery
                 "USACH", ## 168. Karina Arias Yurisch
                 "UCHILE", ## 169. Álvaro Ramírez-Alujas
                 "UVALPO", ## 170. Diego Barría Traverso
                 "UDP", ## 171. Jhon Jaime-Godoy
                 "UDP", ## 172. Vicente Faúndez Caicedo
                 "UDP", ## 173. Carolina Pérez Aburto
                 "UDP", ## 174. Caterina Bo Guzman
                 "UDP", ## 175. Verónica Figueroa-Gutiérrez
                 "LSE", ## 176. Diego Sazo
                 "USACH", ## 177. Mariana Chudnovsky
                 "UCHILE", ## 178. Isabel Castillo Carniglia
                 "CEP", ## 179. Carmen Le Foulon
                 "UAH", ## 180. Felipe Livert
                 "UAH" ## 181. Francesco Penaglia
                 )
...
## Export CSV
write.csv(data,'20230303/20230303_ranking.csv', fileEncoding = "UTF-8")
save.image("20230303/Ranking-Mar-2023.RData")

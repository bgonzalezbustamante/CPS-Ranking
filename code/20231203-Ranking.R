...
Name <- c(POHGEtYAAAAJ$name, ## Alejandro Olivares L.
          ...
          desdAPoAAAAJ$name, ## Ignacio Cienfuegos
...
Affiliation <- c("UMAYOR", ## 1. Alejandro Olivares L.
                 ...
                 "Leiden", ## 8. Bastián González-Bustamante
                 ...
                 "PUC", ## 126. Stefano Palestini
                 "PUC", ## 127. Ross Mittiga
...
## Export CSV
write.csv(data,'20231203/20231203_ranking.csv', fileEncoding = "UTF-8")
save.image("20231203/Ranking-Dec-2023.RData")

...
Affiliation <- c("UMAYOR", ## 1. Alejandro Olivares L.
                 ...
                 "UACH", ## 18. Claudio Fuentes-González
                 ...
                 "UDP", ## 60. Kenneth Bunker
                 "LSE-COES", ## 61. Kirsten Sehnbruch
                 "STU", ## 62. Laura Levick
                 "UDP-UAM", ## 63. Lisa Zanotti
...
## Export CSV
write.csv(data,'20230601/20230601_ranking.csv', fileEncoding = "UTF-8")
save.image("20230601/Ranking-Jun-2023.RData")
